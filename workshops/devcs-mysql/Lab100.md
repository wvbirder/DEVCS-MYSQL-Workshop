...
- Packer and Terraform are both open source tools from Hashcorp that are integrated into Developer Cloud Service. They will be used in a Pipeline flow to create the Cloud infrastructure and built out the custom Linux based VM.
- [Packer Documentation](https://www.packer.io/intro/index.html)
- [Terraform Documentation](https://www.packer.io/intro/index.html)
...
- Get an Oracle Trial Acoount
- Use Developer Cloud Service new features of Packer / Terraform / Pipelines / Software Templates
- Generate and Deploy a Custom Image into the student's Oracle Trial account
- Deploy two Node.js applications using DevCS into Application Container CS
- Make a change in a github repo which will fire off a CI/CD build / re-deploy from DevCS
