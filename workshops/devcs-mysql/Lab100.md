...
### **Step 9**: Import a GitHub repository and define the Packer build

In this step you will import a precreated repository into the project and modify a Packer configuration file. Here you will add the various OCIDs that you saved off earlier in the lab into a configuration file. Finally, you will define a Packer build using the Software Template you created in Step 7. This will build and create a Custom Image with MYSQL installed into your Trial Account.
...
- Now, **Back in the Developer project** click on the **build.json** file as we are going to edit some values relative to your Trial Account. 
