...
-Finally, you can go back into the Compute Cloud Service Console and see the newest deployments of the `DevCS_MYSQL` Custom Image and the `MYSQL` Compute instance.
