...
- **Replace the 5 variables above** in the file where the current values are **XXXX-HERE** with the corresponding values you saved in the text editor. You can paste these values into the file using **Ctrl-V**.
...
### **Step 12**: Edit the Terraform configuration file
...
- **Fill in the 4 variables above** with the corresponding values you saved earlier. You can paste into the file using **Ctrl-V**.
...
### **STEP 17a**: SSH into the `MYSQL` Compute Instance (Windows)
...
### **STEP 17b**: SSH into the `MYSQL` Compute Instance (Linux/Mac)
...
- Make sure your private key file has the permissions of "600".

  - **Type:** (using the name you gave the key file):
