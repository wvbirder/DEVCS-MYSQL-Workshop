...
- Gather the Tenancy OCID to be used by clicking the **hamburger icon** in the upper left corner to open the navigation menu. Under the Administration section of the menu, click **Tenancy Details**. editor.
...
### **STEP 5**: Configure Developer Cloud Service Connections
