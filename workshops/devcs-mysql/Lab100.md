...
**ADD VERBAGE and/or diagram here on Key Usage in Oracle OCI**
...
You need to create two sets of SSH keys, the API key pair will allow access via an API to work with your cloud user account assets and the other key pair will be used to securely connect to a Compute Instance you will creating later on in this lab.
...
- On your local server open up the **oci_api_key_pem.pub** using your favorite text editor. Select the entire contants and right-click **Copy**:
...
- In the `Configure OCI Account` dialog you will be Copying and Pasting the values you have saved in your text editor for:
   ...
   - **Private Key:** **Copy and Paste** the contents of the **oci_api_key.pem** file in the Git Repository
   - **Fingerprint** 
   - **Compartment OCID**
   - **Storage Namespace**
