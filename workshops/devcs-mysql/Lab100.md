...
- Add your Trial account **Username** and **Password** and the completed dialog should look something like the example below:
...
In this step you will import a GitHub repository into the project and modify a Packer configuration file. Here you will add the various OCIDs that you saved off earlier in your text editor.
...
- You will see the repository contents displayed. Click on the **oci_api_key_public.pem** file. This is a pre-created public API key required for REST API access to our Compute Service. You will copy and paste the contents into your Compute Service User. 
...
- If you no longer have the Compute Service Console opened for earlier in this lab go back to the main Dashboard, click on the Compute Service **hamburger menu**, right-click on **Open Service Console** and select **Open link in new tab**.
...
- **Cut and Paste** the following into the Script section:
...
In this step you will edit the Terraform config file.
