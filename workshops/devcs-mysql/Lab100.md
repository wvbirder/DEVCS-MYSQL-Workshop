...
- If using Windows and your OS does not have the 'curl' utility (earlier than August of 2017), then download and unzip from here: [curl for Windows](https://curl.haxx.se/windows/). (You can open up a Command Prompt window and type **curl** to find out. Later versions of Windows 10 and above have curl bundled)
