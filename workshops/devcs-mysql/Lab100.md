...
- Back in the main Dashboard click on the Comp

- You will see the repository contents displayed. Click on the **build.json** file as we are going to edit some values relative to your Trial Account. 
