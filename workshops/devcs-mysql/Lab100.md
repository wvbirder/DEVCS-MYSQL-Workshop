...
In this step you're SSH'ed into the `MYSQL` Compute instance and you'll execute a few commands to verify that MYSQL was installed OK and the database schema for the AlphaOffice application is there.

**This completes this Lab, please proceed to Lab 200!**
