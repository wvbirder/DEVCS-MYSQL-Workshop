...
- Click the **hamburger icon** in the upper left corner to open the navigation menu. Under the **Identity** section of the menu, click **Compartments**
  ...
  - Save off your `OCID` of the new compartment by clicking the **Copy** link. Paste this into a text editor of your choice as we will be referencing this later on in the labs.
